...
final class KeyPairTests: XCTestCase {
	...
	func testRegular() throws {
		...
		XCTAssert(keyPair1?.privateKey.sign(bytes: messageToSign)?.hexString == "c4d20c77d627d8c07e3f26ddc2e8ab9324471c65f9abd412de70a81c21ddc153dcfad1b31ab777a83c4e8a5dc021ea30d84da107dea4a192fc2ca9da9b3ede00",
				  keyPair1?.privateKey.sign(bytes: messageToSign)?.hexString ?? "-")
		...
		XCTAssert(keyPair2?.privateKey.sign(bytes: messageToSign)?.hexString == "699bc6f9f3ad5987e02b5b2dfccfa86c5583be632bd60840abd5a14c94fb7dea43e39d1f08b8d406a26bf2de337313e8dad054a26b93fec76063e24bde6b8495",
				  keyPair2?.privateKey.sign(bytes: messageToSign)?.hexString ?? "-")
		...
		XCTAssert(keyPair3?.privateKey.sign(bytes: messageToSign)?.hexString == "f83f6075f87269ae141843bda4867942e4f9f7a299289eaed7f2185ad1ad0bb71e5b976e5a3169b32756d5d87a05875d2d3fc3615cc1509ab05c46df8d30b705",
				  keyPair3?.privateKey.sign(bytes: messageToSign)?.hexString ?? "-")
		...
		XCTAssert(keyPair4?.privateKey.sign(bytes: messageToSign)?.hexString == "1f19dd5887c4e739377f1303db66bc12863942bc969ea29055152ddf7f25d32c0e8ff3ea8ac18ab58f328b830debad43e78cbf483dad38441301f59e6af633fa",
	...
	func testHD() throws {
		...
		XCTAssert(keyPair1?.privateKey.sign(bytes: messageToSign)?.hexString == "d9f272a3ed8459e0b51575dc6660628e64acb231d813f04dc5c2417addd181ddf9da7fe128ed492520c77476d3db3572277b91faabd10b219a4abe6e4f83a900",
				  keyPair1?.privateKey.sign(bytes: messageToSign)?.hexString ?? "-")
		...
		XCTAssert(keyPair2?.privateKey.sign(bytes: messageToSign)?.hexString == "c1d9165f9b7670bed93abb8a800bdf725b4c63c15de08f17a1d23dd6cdb5dd993e9950efec84a77c573062d82877099e1ce4c22e82982b59412874c3cec8de0a",
				  keyPair2?.privateKey.sign(bytes: messageToSign)?.hexString ?? "-")
		...
		XCTAssert(keyPair3?.privateKey.sign(bytes: messageToSign)?.hexString == "cc9e7d3bff6a17c8f3a6385397fb0d4e3136742e7e78f4719e7971223b3633a23c73a98d2a143d3693f480d93776506b38a9a8ec571e289b1e75b0a4bd26b200",
				  keyPair3?.privateKey.sign(bytes: messageToSign)?.hexString ?? "-")
